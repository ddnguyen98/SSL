    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel" >
        <div class="carousel-inner">
            <div class="carousel-item active" style="height: 800px">
                <img src="assets/img/dog1.jpg" style="height: 100%" class="d-block w-100" alt="">
            </div>
            <div class="carousel-item" style="height: 800px">
                <img src="assets/img/dog2.jpg" style="height: 100%" class="d-block w-100" alt="">
            </div>
            <div class="carousel-item" style="height: 800px">
                <img src="assets/img/dog3.jpg" style="height: 100%" class="d-block w-100" alt="">
            </div>
        </div>
